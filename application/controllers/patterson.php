...
class Patterson extends CI_Controller {
    ...
    function main() {
        ...
        foreach ($data['content'] as $row):
			...
			$data['localsearch'] = $row->local_search_fee;
		...
		if($data['sale_price'] > 0) {
			...
			$data['free_sale'] = $this->conveyquote->quote($data['sale_price'], $leasehold='freehold', $mortgage=0, $data['sale_price'], $leaseholdsale='freehold', $purchasefee=0, $salefee=0, $data['localsearch']);
			
		}
if($data['sale_price_leasehold'] > 0) {
			
			$data['lease_sale'] = $this->conveyquote->quote($data['sale_price_leasehold'], $leasehold='leasehold', $mortgage=0, $data['sale_price_leasehold'], $leaseholdsale='leasehold', $purchasefee=0, $salefee=0, $data['localsearch']);
